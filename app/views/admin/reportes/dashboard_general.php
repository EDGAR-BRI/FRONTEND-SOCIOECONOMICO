...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-5">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-5">
        <p class="text-xs uppercase tracking-wide text-gray-500">Tasa de respuesta</p>
        <h3 class="text-2xl font-bold text-green-700 mt-1"><?php echo number_format($tasaRespuesta, 2, ',', '.'); ?>%</h3>
    </div>
    <div class="bg-white rounded-lg shadow-sm border p-5">
