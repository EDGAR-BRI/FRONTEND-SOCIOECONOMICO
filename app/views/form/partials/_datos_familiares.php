<div class="card">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="padre_trabaja" value="1"
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="padre_en_venezuela" value="1"
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="padre_egresado_iujo" value="1"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="madre_trabaja" value="1"
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="madre_en_venezuela" value="1"
        ...
        <div>
            ...
            <div class="flex gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="madre_egresada_iujo" value="1"
