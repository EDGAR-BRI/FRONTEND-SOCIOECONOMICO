...
<div id="Logo" class="group flex items-center justify-center gap-5 mt-auto mb-6 w-auto h-20 ">
    <div class="flex items-center justify-center leading-none [&>svg]:w-auto [&>svg]:h-14 [&>svg]:block max-[600px]:[&>svg]:h-10 <?php echo $logoTextClass; ?>">
    ...
    <div class="flex items-center justify-center leading-none [&>svg]:w-auto [&>svg]:h-16 [&>svg]:block max-[600px]:[&>svg]:h-10 <?php echo $logoTextClass; ?>">
